...
public class Quiz5 extends Testbase
{
	public void Quiz_5_test_fun() throws InterruptedException 
	{
		...
		System.out.println("----------------------Session 5 started -----------------------");
		...
		Thread.sleep(1000);
		videopage.clickStart_test_session_1(); 
		System.out.println("Quiz 5 Started");
		
		//Quiz 5
		Thread.sleep(1000);
		Quiz_1_Page.Get_Input_AndClick_Quiz_Option("None of the Above");
		videopage.clickNextbutton_For_all_Page();
		System.out.println("Question 1 attempted succssefuly ");
		Thread.sleep(1000);
		quiz_1.Get_Input_AndClick_Quiz_Option("Save");
		...
		System.out.println("----------------Session 5 Completed successfully---------------------");
	}
}
