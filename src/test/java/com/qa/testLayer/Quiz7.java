...
public class Quiz7 extends Testbase
{
	public void Quiz_7_test_fun() throws InterruptedException 
	{
		...
		System.out.println("----------------------Session 7 started -----------------------");
	...
	/*	Thread.sleep(2000);
		...
		Thread.sleep(1000);
		videopage.clickStart_test_session_1();
		System.out.println("Quiz 7 Started");
		//Quiz 7
		Thread.sleep(1000);
		Quiz_1_Page.Get_Input_AndClick_Quiz_Option("=");
		videopage.clickNextbutton_For_all_Page();
		System.out.println("Question 1 attempted succssefuly ");
		Thread.sleep(1000);
		quiz_1.Get_Input_AndClick_Quiz_Option("Rows and Columns");
		...
		System.out.println("----------------Session 7 Completed successfully---------------------");
