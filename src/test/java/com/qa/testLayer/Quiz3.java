...
public class Quiz3 extends Testbase
{
	public void Quiz_3_test_fun() throws InterruptedException 
	{
		...
		Thread.sleep(1000);
		videopage.clickStart_test_session_1(); 
		System.out.println("Quiz 3 Started");	
		//Quiz 3
		Thread.sleep(1000);
		Quiz_1_Page.Get_Input_AndClick_Quiz_Option("Center");
		videopage.clickNextbutton_For_all_Page();
		System.out.println("Question 1 attempted succssefuly ");
		Thread.sleep(1000);
		quiz_1.Get_Input_AndClick_Quiz_Option("All of the Options");
		...
		System.out.println("Quiz 3 Completed successfully");
		System.out.println("----------------Session 3 Completed successfully---------------------");
